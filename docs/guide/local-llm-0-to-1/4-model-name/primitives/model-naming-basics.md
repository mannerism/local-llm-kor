...
이 기본편에서는 **가장 단순한 모델 이름**을 읽는 법만 다뤄요. 더 복잡한 표기(MoE, 양자화, 파일 형식 등)는 [[model-naming-advanced|응용편]]에서 봅니다.
...
> 💡 더 복잡한 이름 (예: `froggeric/Qwen3.6-27B-MTP-GGUF`)은 [[model-naming-advanced|응용편]]에서 다룹니다.
