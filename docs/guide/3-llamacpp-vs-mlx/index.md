...
## 1. llama.cpp {#primitive-llama-cpp}
<!-- SYNC:BEGIN src="3-llama-cpp-vs-mlx/primitives/llama-cpp.md" demote="1" -->
### 이게 뭐예요?
...
<!-- SYNC:END src="3-llama-cpp-vs-mlx/primitives/llama-cpp.md" -->

---

## 2. MLX {#primitive-mlx}
<!-- SYNC:BEGIN src="3-llama-cpp-vs-mlx/primitives/mlx.md" demote="1" -->
### 이게 뭐예요?
...
<!-- SYNC:END src="3-llama-cpp-vs-mlx/primitives/mlx.md" -->
