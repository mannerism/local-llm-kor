...
## 하드웨어 — 메모리가 핵심 {#primitive-메모리-대역폭}

### 1. 메모리 대역폭 (1순위 결정 요인)
<!-- SYNC:BEGIN src="5-model-speed/primitives/메모리-대역폭.md" demote="1" -->
### 이게 뭐예요?
...
<!-- SYNC:END src="5-model-speed/primitives/메모리-대역폭.md" -->

---

### 2. 메모리 용량과 헤드룸
<!-- SYNC:BEGIN src="5-model-speed/primitives/메모리-용량과-헤드룸.md" demote="1" -->
### 이게 뭐예요?
**모델이 내 맥북에 들어갈 수 있느냐의 문제예요.** [메모리-대역폭](#primitive-메모리-대역폭)이 "얼마나 빠른가"를 결정한다면, 메모리 용량은 "돌릴 수 있는가 없는가"를 결정합니다.
...
<!-- SYNC:END src="5-model-speed/primitives/메모리-용량과-헤드룸.md" -->

---

## 모델 자체 — 같은 하드웨어에서도 모델에 따라 다름 {#primitive-양자화와-속도}

### 3. 양자화와 속도
<!-- SYNC:BEGIN src="5-model-speed/primitives/양자화와-속도.md" demote="1" -->
### 이게 뭐예요?
**양자화 레벨은 모델 크기를 결정하고, 모델 크기는 속도를 결정해요.** 같은 모델이어도 Q4와 Q8은 거의 두 배 속도 차이가 납니다.

> 💡 양자화 표기법은 [모델 이름 응용편](/guide/4-model-name/#primitive-로컬-모델-이름-이해하기-응용편)에서 확인할 수 있어요.
...
<!-- SYNC:END src="5-model-speed/primitives/양자화와-속도.md" -->

---

### 4. Dense vs MoE 속도 차이
<!-- SYNC:BEGIN src="5-model-speed/primitives/Dense-vs-MoE-속도.md" demote="1" -->
### 이게 뭐예요?
**MoE 모델은 같은 메모리를 쓰면서도 훨씬 빨라요.** "큰 모델의 똑똑함"과 "작은 모델의 속도"를 둘 다 가져가려는 구조입니다.

> 💡 MoE/Dense 표기법은 [모델 이름 응용편](/guide/4-model-name/#primitive-로컬-모델-이름-이해하기-응용편)에서 확인할 수 있어요.
...
<!-- SYNC:END src="5-model-speed/primitives/Dense-vs-MoE-속도.md" -->

---

### 5. 컨텍스트 길이와 Prefill
<!-- SYNC:BEGIN src="5-model-speed/primitives/컨텍스트-prefill.md" demote="1" -->
### 이게 뭐예요?
...
- `-c` 플래그로 컨텍스트 크기 조절
<!-- SYNC:END src="5-model-speed/primitives/컨텍스트-prefill.md" -->

---

## 소프트웨어 — 마지막 최적화 {#primitive-추론-엔진-플래그}

### 6. 추론 엔진과 플래그 튜닝
<!-- SYNC:BEGIN src="5-model-speed/primitives/추론-엔진-플래그.md" demote="1" -->
### 이게 뭐예요?
...
- `-t`는 성능 코어 수에 맞춤
- `-fa`는 켜두기
<!-- SYNC:END src="5-model-speed/primitives/추론-엔진-플래그.md" -->

---

### 7. 추론 가속 기술 (MTP, Speculative Decoding 등)
<!-- SYNC:BEGIN src="5-model-speed/primitives/가속-기술.md" demote="1" -->
### 이게 뭐예요?
...
<!-- SYNC:END src="5-model-speed/primitives/가속-기술.md" -->

---

## 실전 — 어떻게 살까 {#primitive-하드웨어-구매-가이드}

### 8. 하드웨어 구매 가이드
<!-- SYNC:BEGIN src="5-model-speed/primitives/하드웨어-구매-가이드.md" demote="1" -->
### 이게 뭐예요?
**LLM 용도로 맥북·맥을 새로 살 때 어떤 스펙을 봐야 하는지 정리한 가이드예요.** 앞에서 본 [메모리-대역폭](#primitive-메모리-대역폭)·[메모리-용량과-헤드룸](#primitive-메모리-용량과-헤드룸) 개념을 실제 구매 결정으로 옮기는 단계입니다.
...
2. 메모리는 **돌릴 모델 크기 ÷ 0.6**
3. 저장은 **1TB 이상**
<!-- SYNC:END src="5-model-speed/primitives/하드웨어-구매-가이드.md" -->
