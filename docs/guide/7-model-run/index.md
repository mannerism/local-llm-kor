...
## 1. llama.cpp PR 빌드 {#primitive-llama-cpp-pr-빌드}
...
<!-- SYNC:BEGIN src="7-model-run/primitives/llama-cpp-pr-빌드.md" demote="1" -->
### 이게 뭐예요?
...
버전 정보 뜨면 성공.
<!-- SYNC:END src="7-model-run/primitives/llama-cpp-pr-빌드.md" -->

---
## 2. 모델 다운로드 {#primitive-huggingface-다운로드}

<!-- SYNC:BEGIN src="7-model-run/primitives/huggingface-다운로드.md" demote="1" -->
### 이게 뭐예요?
...
<!-- SYNC:END src="7-model-run/primitives/huggingface-다운로드.md" -->
...
## 3. MTP 실행 {#primitive-모델-시험-해보기}

<!-- SYNC:BEGIN src="7-model-run/primitives/모델-시험-해보기.md" demote="1" -->
### 이게 뭐예요?
**다운받은 GGUF 모델을 실제로 띄워서 돌려보는 방법이에요.** llama-server로 OpenAI 호환 API 서버를 띄우고, curl로 프롬프트 보내서 응답과 토큰 속도를 확인합니다.

### 준비물

- llama.cpp 설치 (brew 또는 [PR 빌드](#primitive-llama-cpp-pr-빌드))
- GGUF 모델 파일 (다운받은 위치)
...
플래그 의미는 [추론-엔진-플래그](/guide/5-model-speed/#primitive-추론-엔진-플래그)·[가속-기술](/guide/5-model-speed/#primitive-가속-기술) 참고.
...
<!-- SYNC:END src="7-model-run/primitives/모델-시험-해보기.md" -->
