...
<!-- SYNC:BEGIN src="8-terminal-agent/primitives/pi.md" demote="1" -->
...
<!-- SYNC:END src="8-terminal-agent/primitives/pi.md" -->

---

## Pi 설치 {#primitive-pi-설치}

<!-- SYNC:BEGIN src="8-terminal-agent/primitives/pi-설치.md" demote="1" -->
### 1. Node.js + pnpm 설치
...
Pi 설치 완료.
<!-- SYNC:END src="8-terminal-agent/primitives/pi-설치.md" -->

---

## llama-server 연결 {#primitive-pi-llama-server-연결}

<!-- SYNC:BEGIN src="8-terminal-agent/primitives/pi-llama-server-연결.md" demote="1" -->
...
<!-- SYNC:END src="8-terminal-agent/primitives/pi-llama-server-연결.md" -->
...
<!-- SYNC:END src="8-terminal-agent/primitives/속도-향상.md" -->
